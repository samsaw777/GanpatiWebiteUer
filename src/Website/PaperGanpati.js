...
export default function PaperGanpati() {
    ...
    useEffect(()=>{
        const getImages = []
        db.collection('ganpatiSamplesPaper').onSnapshot(
            snapshot =>{
    ...
    const filterImages = value =>{
        ...
        db.collection('ganpatiSamplesPaper').where('Height','==',value).onSnapshot(
            snapshot =>{
                                ...
                                <div className='filterprice'>
                                    ...
                                    <form>
                                        <div className={arrow?'filterheight':'filterheightHide'}>
                                            ...
                                            <div className='innerInput'><input type='radio' value='42' checked={currentRadio==='42'} onChange={e=>filterImages(e.target.value)}/><span>42 Inch Mutri</span></div>
                                            <div className='innerInput'><input type='radio' value='48' checked={currentRadio==='48'} onChange={e=>filterImages(e.target.value)}/><span>48 Inch Mutri</span></div>
                                            <div className='innerInput'><input type='radio' value='54' checked={currentRadio==='54'} onChange={e=>filterImages(e.target.value)}/><span>54 Inch Mutri</span></div>
                                            <div className='innerInput'><input type='radio' value='60' checked={currentRadio==='60'} onChange={e=>filterImages(e.target.value)}/><span>60 Inch Mutri</span></div>
                                            <div className='innerInput'><input type='radio' value='66' checked={currentRadio==='66'} onChange={e=>filterImages(e.target.value)}/><span>66 Inch Mutri</span></div>
                                            <div className='innerInput'><input type='radio' value='72' checked={currentRadio==='72'} onChange={e=>filterImages(e.target.value)}/><span>72 Inch Mutri</span></div>
                                        </div>
                                    </form>
                                </div>
                            </div>
